...
namespace Entities
{
    ...
    public class Etyma
    {
        ...
        [SugarColumn(Length = 100, IsNullable = false, ColumnDescription = "单词")]
        public string Word { get; set; }


        [SugarColumn(Length = 8000, IsNullable = false, ColumnDescription = "词根描述")]
        public string Desc { get; set; }

        [SugarColumn(Length = 4000, IsNullable = true, ColumnDescription = "引申含义")]
        public string Extention { get; set; }

        [SugarColumn(Length = 500, IsNullable = true, ColumnDataType = "Nvarchar", ColumnDescription = "英式音标")]
        ...
        [SugarColumn(Length = 500, IsNullable = true, ColumnDataType = "Nvarchar", ColumnDescription = "美式音标")]
        ...
        [SugarColumn(Length = 10000, IsNullable = false, ColumnDescription = "词根描述")]
